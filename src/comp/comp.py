...
c = []
parameters = ["C", "D", "E", "G"]
c = [human.name for human in humans if human.name[0] in parameters]
...
f = [(human.name, human.age) for human in humans if range(27, 33)]
print(f)
...
g = []
list_copy = humans[:]
g = [Human(human.name.upper(), human.age + 5) for human in list_copy]
print(g)
print(humans, "Original list")
